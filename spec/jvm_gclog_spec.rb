    ...
    context "given log" do
      describe "YoungGC" do
        before :each do
          ...
          @time, @r = @jvmgclog.parse(@line)
        end

        it "should have expected values" do
          expect(@time).to eq 1433477732
